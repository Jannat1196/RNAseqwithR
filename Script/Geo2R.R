...
View(tT)
tT1 <- subset(tT, select=c("ID","adj.P.Val","P.Value","t","B","logFC","GenBank.Accession","Platform_SPOTID","Gene.symbol","Gene.title"))
View(tT1)
...
View(tT2)
hist(tT2$adj.P.Val, col = "red", border = "white", xlab = "P-adjusted value",
...
# ggplot with non-overlapping labels
